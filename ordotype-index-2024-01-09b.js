...
const ES_INDEX_STAGING = "ordotype-index-staging-2024-01-04"; // old: ordotype-index-staging-2024-01-04 
const ES_INDEX_PRODUCTION = "ordotype-index-production-2024-01-09d"; // old : ordotype-index-2023-12-21c
...
function displayResults(results, input) {
  ...
  results.forEach((result, index) => {
    ...
    if (result.gratos == "FALSE") {
        ...
        img.style.opacity = "0";  // Make the empty space (img) invisible
    }
